...
export default function Home() {
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <p className="text-lg mb-8" style={{ color: 'var(--on-surface)' }}>
      ...
      <div className="space-y-6">
        <section>
          ...
          <p style={{ color: 'var(--on-surface)' }}>
            Flora is designed around tree-shakable, performance-first component
            architecture with selective imports.
          </p>
        </section>
      </div>
    </div>
