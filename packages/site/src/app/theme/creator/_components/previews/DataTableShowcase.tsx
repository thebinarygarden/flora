...
export function DataTableShowcase() {
    ...
    const users = [
        { id: 1, name: 'Alice Johnson', email: 'alice@example.com', role: 'Admin', status: 'Active', joined: '2023-01-15', lastLogin: '2 hours ago' },
        { id: 2, name: 'Bob Smith', email: 'bob@example.com', role: 'Editor', status: 'Active', joined: '2023-03-22', lastLogin: '1 day ago' },
        { id: 3, name: 'Carol White', email: 'carol@example.com', role: 'Viewer', status: 'Inactive', joined: '2023-05-10', lastLogin: '2 weeks ago' },
        { id: 4, name: 'David Brown', email: 'david@example.com', role: 'Editor', status: 'Active', joined: '2023-07-08', lastLogin: '5 minutes ago' },
        { id: 5, name: 'Emma Davis', email: 'emma@example.com', role: 'Admin', status: 'Active', joined: '2023-09-14', lastLogin: '1 hour ago' },
        { id: 6, name: 'Frank Wilson', email: 'frank@example.com', role: 'Viewer', status: 'Pending', joined: '2024-01-20', lastLogin: 'Never' },
    ];
        ...
        <div className="space-y-8">
            ...
            <div className="text-center space-y-4">
                ...
                <p className="text-lg opacity-70" style={{ color: 'var(--on-background)' }}>
                    Showcasing surfaceVariant in table headers, rows, filters, and pagination
                </p>
            </div>
            ...
            <Card>
                ...
                >
                    ...
                    {selectedRows.length > 0 && (
                        <div className="flex items-center justify-between p-3 rounded" style={{ backgroundColor: 'var(--primary)', color: 'var(--on-primary)' }}>
            ...
            <Card>
                                                ...
                                                <div className="space-y-4">
                                                    ...
                                                    <div className="grid md:grid-cols-2 gap-6">
                                                        ...
                                                        <div className="space-y-3">
                                                            ...
                                                            <div>
                                                                <p className="text-sm opacity-70">Joined Date</p>
                ...
                >
                    <div className="text-sm opacity-80">
                        Showing {((currentPage - 1) * 10) + 1} to {Math.min(currentPage * 10, 50)} of 50 results
                    </div>
                    <div className="flex gap-2">
                        <Button
                            size="sm"
                            ...
                            {[1, 2, 3, 4, 5].map(page => (
                                <button
                                    ...
                                    style={{
                                        ...
                                        color: currentPage === page ? 'var(--on-primary)' : 'var(--on-surface)'
                                    }}
                                >
                                    {page}
                                </button>
                ...
                <div className="p-6 space-y-4">
                    ...
                    <div className="overflow-x-auto rounded-lg">
                        <table className="w-full text-xs">
                            ...
                            <tbody>
                                {[
                                    { id: 'TXN-001', date: '2024-01-15', desc: 'Payment received', amount: '+$1,234.56', status: 'Completed' },
                                    { id: 'TXN-002', date: '2024-01-14', desc: 'Refund processed', amount: '-$89.00', status: 'Completed' },
                                    { id: 'TXN-003', date: '2024-01-14', desc: 'Subscription renewal', amount: '+$49.99', status: 'Pending' },
                                    { id: 'TXN-004', date: '2024-01-13', desc: 'Payment received', amount: '+$2,500.00', status: 'Completed' },
                                    { id: 'TXN-005', date: '2024-01-12', desc: 'Chargeback', amount: '-$150.00', status: 'Failed' },
                                ].map((txn, index) => (
                                    <tr
                                        key={txn.id}
                                        className="border-b"
                                        style={{
                                            backgroundColor: index % 2 === 0 ? 'var(--surface)' : 'var(--surface-variant)',
                                            color: index % 2 === 0 ? 'var(--on-surface)' : 'var(--on-surface-variant)',
                                            borderColor: 'var(--border)'
                                        }}
                                    >
                                        ...
                                        <td className="p-2 font-medium" style={{ color: txn.amount.startsWith('+') ? 'var(--success)' : 'var(--error)' }}>
                                            {txn.amount}
                                        </td>
                                        <td className="p-2">
                                            <Badge
                ...
                <div className="p-6 space-y-4">
                    ...
                    <div className="overflow-x-auto rounded-lg">
                        <table className="w-full text-sm">
                            ...
                            <tbody>
                                <tr className="border-b" style={{ borderColor: 'var(--border)', color: 'var(--on-background)' }}>
                                    ...
                                    <td className="p-3 text-right" style={{ color: 'var(--success)' }}>+12.5%</td>
                                </tr>
                                <tr className="border-b" style={{ borderColor: 'var(--border)', color: 'var(--on-background)' }}>
                                    ...
                                    <td className="p-3 text-right" style={{ color: 'var(--success)' }}>+8.3%</td>
                                </tr>
                                <tr className="border-b" style={{ borderColor: 'var(--border)', color: 'var(--on-background)' }}>
                                    ...
                                    <td className="p-3 text-right" style={{ color: 'var(--error)' }}>+3.2%</td>
                                </tr>
                                <tr className="border-b" style={{ borderColor: 'var(--border)', color: 'var(--on-background)' }}>
                                    ...
                                    <td className="p-3 text-right" style={{ color: 'var(--success)' }}>+5.1%</td>
                                </tr>
                                <tr style={{ color: 'var(--on-background)' }}>
                                    ...
                                    <td className="p-3 text-right">1,234</td>
                                    <td className="p-3 text-right" style={{ color: 'var(--success)' }}>+18.7%</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
