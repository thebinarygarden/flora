...
export function LandingPageShowcase() {
    ...
    const testimonials = [
        {
            quote: "This design system transformed our workflow. We ship features 3x faster now.",
            author: "Sarah Chen",
            role: "Head of Design",
            company: "TechCorp",
    ...
    const pricingTiers: Array<{
        ...
        },
        {
            ...
            color: 'secondary',
            popular: true,
            features: ['200+ Components', 'Advanced Templates', 'Priority Support', 'Custom Themes', 'Figma Integration'],
            cta: 'Get Started'
        },
        {
            name: 'Enterprise',
    ...
    const features: Array<{
        ...
        },
        {
            ...
            description: 'Theme system that adapts to your brand with CSS custom properties',
            icon: '🎨',
            color: 'secondary',
                ...
                <Card variant="flat" padding="large">
                    <div className="text-center max-w-4xl mx-auto">
                        ...
                        >
                            ...
                            <span style={{ color: 'var(--secondary)' }}> beautiful interfaces </span>
