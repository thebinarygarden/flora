          ...
          <div className="space-y-3">
            ...
            >
              ...
              <div className="flex-1">
                ...
                <p className="text-sm opacity-90">
                  Routine maintenance will occur Saturday 2-4 AM EST. No action
                  needed.
                </p>
              </div>
            </div>
        ...
        <Card variant="outlined" padding="medium">
          ...
          <div className="space-y-6">
            <p
              ...
              style={{ color: 'var(--on-surface)' }}
            >
              These elements use variant surface colors for emphasis and
              contrast
            </p>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              >
                ...
                <button
                  className="ml-2 text-xs px-2 py-1 rounded opacity-80 hover:opacity-100"
                  style={{
